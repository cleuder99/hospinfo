            ...
            <?php
              ...
              if($qtd > 0){
                ...
                while($row = $res->fetch_assoc()){
                  ...
                  print "<td>".$row["sobrenome_usuario"]."</td>";
                        print "<td>".$row["email_usuario"]."</td>";
                  print "<td>
                        <button onclick=\"location.href='editar-usuario.php?acao=editar&id_usuario=".$row["id_usuario"]."';\" class='btn btn-success'>Editar</button>

                        <button onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='manter-usuario.php?acao=excluir&id_usuario=".$row["id_usuario"]."';}else{false;};\"  class='btn btn-danger'>Excluir</button>
                       </td>";
                  print "</tr>";
                }
                print "</table>";
