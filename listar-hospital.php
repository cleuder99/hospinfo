      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <h1>Lista de Hospitais</h1>
            <?php
              $sql = "SELECT * FROM hospital ORDER BY nome_hospital";
              ...
              if($qtd > 0){
                ...
                while($row = $res->fetch_assoc()){
                  ...
                  print "<td>".$row["telefone_hospital"]."</td>";
                  print "<td>
                        <button onclick=\"location.href='editar-hospital.php?acao=editar&id_hospital=".$row["id_hospital"]."';\" class='btn btn-success'>Editar</button>
                        <button onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='manter-hospital.php?acao=excluir&id_hospital=".$row["id_hospital"]."';}else{false;};\"  class='btn btn-danger'>Excluir</button>
                       </td>";
                  print "</tr>";
                }
                print "</table>";
