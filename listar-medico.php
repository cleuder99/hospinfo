        ...
        <div class="container-fluid">
          <h1>Lista de Médicos</h1>
            <?php
              ...
              $sql = "select m.id_medico, m.nome_medico, h.nome_hospital, e.nome_especialidade from medico m
                      join hospital h
              ...
              if($qtd > 0){
                ...
                while($row = $res->fetch_assoc()){
                  ...
                  print "<td>
                        <button onclick=\"location.href='editar-medico.php?id_medico=".$row["id_medico"]."';\" class='btn btn-success'>Editar</button>

                        <button onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='manter-medico.php?acao=excluir&id_medico=".$row["id_medico"]."';}else{false;};\"  class='btn btn-danger'>Excluir</button>
                       </td>";
                  print "</tr>";
                }
                print "</table>";
