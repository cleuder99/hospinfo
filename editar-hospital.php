      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="container col-md-10">
            <h1><center>Editar Hospital</center></h1>,            
            <?php
            ...
            <input type="hidden" name="acao" value="editar">
              ...
              <div class="form-group">
                ...
                <input type="text" name="endereco_hospital" class="form-control" value="<?php print $row["endereco_hospital"]; ?>">
              </div>
              <div class="form-group">
                <label>Telefone</label>
                <input type="text" name="telefone_hospital" class="form-control" value="<?php print $row["telefone_hospital"]; ?>">
              </div>
