      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="container col-md-10">
            <h1><center>Cadastrar Usuário</center></h1>
            <form action="manter-usuario.php" method="POST" name="formuser">
            <input type="hidden" name="acao" value="cadastrar-administrador">
              ...
              <div class="form-group">
                ...
                <input type="text" name="sobrenome_usuario" class="form-control">
              </div>
              <div class="form-group">
                <label>Email</label>
              ...
              <div class="form-group">
                <label>Senha</label>
                <input type="password" name="senha_usuario" id="senha_usuario" class="form-control" onkeyup="validarSenhaForca()">
              </div>
              <div class="form-group">
          ...
          <script type="text/javascript">
            function validar(){
              ...
              var nome_usuario = formuser.nome_usuario.value;
              var sobrenome_usuario = formuser.sobrenome_usuario.value;
              var email_usuario = formuser.email_usuario.value;

              if(nome_usuario == ""){
                alert('Campo nome obrigratório');
                formuser.nome_usuario.focus();
                return false;
              }

              if(sobrenome_usuario == ""){
                alert('Campo sobrenome obrigratório');
                formuser.sobrenome_usuario.focus();
                return false;
              }

              if(email_usuario == ""){
                alert('Campo email obrigratório');
                formuser.email_usuario.focus();
                return false;
              }
