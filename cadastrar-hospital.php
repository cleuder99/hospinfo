      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="container col-md-10">
            <h1><center>Cadastrar Hospital</center></h1>
            <form action="manter-hospital.php" method="POST" name="formuser">
            <input type="hidden" name="acao" value="cadastrar">
              ...
              <div class="form-group">
                ...
                <input type="text" name="endereco_hospital" class="form-control">
              </div>
              <div class="form-group">
                <label>Telefone</label>
                <input type="text" name="telefone_hospital" class="form-control">
              </div>
          ...
          <script type="text/javascript">
            ...
            function validar(){
              var nome_hospital = formuser.nome_hospital.value;
              var endereco_hospital = formuser.endereco_hospital.value;
              var telefone_hospital = formuser.telefone_hospital.value;

              if(nome_hospital == ""){
                alert('Campo hospital obrigratório');
                formuser.nome_hospital.focus();
                return false;
              }

              if(endereco_hospital == ""){
                alert('Campo endereço obrigratório');
                formuser.endereco_hospital.focus();
                return false;
              }

              if(telefone_hospital == ""){
                alert('Campo telefone obrigratório');
                formuser.telefone_hospital.focus();
                return false;
              }
            }
