      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="container col-md-10 conteudo">
            <h1><center>Cadastrar Médico</center></h1>
          ...
          <script type="text/javascript">
            ...
            function validar(){
              var nome_medico = formuser.nome_medico.value;
              var sobrenome_medico = formuser.sobrenome_medico.value;
              var crm = formuser.crm.value;
              var email_medico = formuser.email_medico.value;
              var hospital = formuser.hospital.value;
              var tipo_atendimento = formuser.tipo_atendimento.value;
              var especialidade = formuser.especialidade.value;
              var hr_entrada = formuser.hr_entrada.value;
              var hr_saida = formuser.hr_saida.value;

              if(nome_medico == ""){
                alert('Campo nome obrigratório');
                formuser.nome_medico.focus();
                return false;
              }

              if(sobrenome_medico == ""){
                alert('Campo sobrenome obrigratório');
                formuser.sobrenome_medico.focus();
                return false;
              }

              if(crm == ""){
                alert('Campo crm obrigratório');
                formuser.crm.focus();
                return false;
              }
              ...
              if(email_medico == ""){
                ...
                formuser.email_medico.focus();
                return false;
              }

              if(hospital == "--- Escolha ---"){
                alert('Campo hospital obrigratório');
                formuser.hospital.focus();
                return false;
              }

              if(tipo_atendimento == "--- Escolha ---"){
                alert('Campo Tipo de Atendimento obrigratório');
                formuser.tipo_atendimento.focus();
                return false;
              }

              if(especialidade == "--- Escolha ---"){
                alert('Campo especialidade obrigratório');
                formuser.especialidade.focus();
                return false;
              }

              if(hr_entrada == ""){
                alert('Campo horário de entrada obrigratório');
                formuser.hr_entrada.focus();
                return false;
              }

              if(hr_saida == ""){
                alert('Campo horário de saída obrigratório');
                formuser.hr_saida.focus();
                return false;
              }
